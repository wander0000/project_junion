            ...
            <div class="sectionInnerFPIC">            
                <div class="sectionConFPIC">
                    ...
                    <div class="sectionInnerWrapperFPIC">
                        <form method="post" action="resetPWI" id="passwordReset">
							<input type="hidden" name="user_email" value="${userEmailP}">

                            <div class="inputName">
                                <h3>비밀번호 설정</h3>
                                <input type="password" class="inputJoin" id="user_pw" name="user_pw" placeholder="영문자, 숫자, 특수문자 포함 총 8~20자" required>
                            </div>
                            <div class="inputName">
                                <h3>비밀번호 확인</h3>
                                <input type="password" class="inputJoin" id="user_pw_check" name="user_pw_check" placeholder="비밀번호를 확인해 주세요" required>
                            </div>
                            ...
                            <div class="buttonRe">
                                <button class="buttonPrev" type="button" onclick="location.href='findPasswordIndividual'">이전</button>
