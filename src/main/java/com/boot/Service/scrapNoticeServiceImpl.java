...
import com.boot.DAO.noticeScrapDAO;
...
public class scrapNoticeServiceImpl implements scrapNoticeService{
	...
	public String getnNoticeScrapArray(String user_email) {//개인회원 정보에 저장된 스크랩공고 arr 가져오기
		noticeScrapDAO dao = sqlSession.getMapper(noticeScrapDAO.class);
