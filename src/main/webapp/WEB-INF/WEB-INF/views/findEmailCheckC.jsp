            ...
            <div class="sectionInnerFEIC">  
                <div class="sectionConFEIC">
                    <div class="sectionConInnerFEIC">
                        <h2>이메일 조회</h2>
                    </div> <!-- 이메일찾기_조회_기업 sectionConInnerFEIC 끝-->
                    <div class="sectionInnerWrapperFEIC">
                        <h3>입력된 정보로 등록된 이메일</h3>
                        <ul>
							<c:forEach var="comEmail" items="${comFindEmail}">
								  
								  <li>${comEmail} </li><br/>
							
							</c:forEach>
						</ul>
                    </div> <!-- 이메일찾기_조회_기업 sectionInnerWrapperFEIC 끝 -->
					<div class="buttonRe">
						<button class="buttonRePW" type="button" onclick="location.href='findPasswordCompany'">비밀번호 찾기</button>
						<button class="buttonLogin" type="button" onclick="location.href='login'">로그인 하기</button>
					</div>
                </div> <!-- 이메일찾기_조회_기업 sectionConFEIC 끝-->
            </div> <!-- 이메일찾기_조회_기업 sectionInnerFEIC 끝 -->
        </section>
